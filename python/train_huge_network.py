...
import numpy as np 
import chess_api
from ChessNN_huge_network import NNetWrapper
import MCTS
import time
import util
import random
...
if load_data:
    nnet.load_checkpoint(folder='board_3x3', filename=f"checkpoint_HN_mcts25_eps100_fen2_{load_number}")
    with open(f'/home/mapu3213/gitrepos/DMU-_FinalProject_AlphaZero/data/eval_data_HN_mcts25_eps50_fen2_{load_number}.pkl', 'rb') as file:
    ...
    while ndx_train_step<args['numTrainingEps']:
        ...
        if (len(experience_buffer)==args['maxBufferSize'] or ndx_train_step>=args['start2train']) and train_delay>=args['trainBatchSize']:
            ...
            if ndx_train_step%1==0:
                nnet.save_checkpoint(folder='board_3x3', filename=f'checkpoint_HN_mcts25_eps100_fen2_{ndx_train_step}.pth.tar')
                with open(f'/home/mapu3213/gitrepos/DMU-_FinalProject_AlphaZero/data/eval_data_HN_mcts25_eps50_fen2_{ndx_train_step}.pkl', 'wb') as picklefile:
            ...
            ax.set_ylim((-1.1, 1.1))
            fig.set_dpi(500)
            plt.savefig('/home/mapu3213/gitrepos/DMU-_FinalProject_AlphaZero/Figs/evals_HN.png')
            ...
            ax.set_ylim((0, 1.1))
            fig.set_dpi(500)
            plt.savefig('/home/mapu3213/gitrepos/DMU-_FinalProject_AlphaZero/Figs/white2win_HN.png')
            ...
            ax.set_ylim((0, 1.1))
            fig.set_dpi(500)
            plt.savefig('/home/mapu3213/gitrepos/DMU-_FinalProject_AlphaZero/Figs/black2win_HN.png') 
